...
import com.andriod.course.adapters.CategoryAdapter;
...
//
    ...
    private void deleteCategory() {
        mDatabase.child("category")
                .child(categoryAdapter.getSelectedCategory().getCategoryId())
                .removeValue()
    ...
    private void setUpRecyclerView(List<Category> categoryList) {
        ...
        RecyclerView.LayoutManager mLayoutManager1 =
                new LinearLayoutManager(RealTimeDatabaseActivity.this, LinearLayoutManager.VERTICAL, false);
